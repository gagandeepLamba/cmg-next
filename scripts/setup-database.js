...
async function run() {
  ...
  console.log(`Database ${database} is ready. Applied ${migrations.length} table/data migrations, checked ${columnMigrations.length} columns, and seeded ${rolePermissionSeed.roles} roles / ${rolePermissionSeed.permissions} permissions.`);
}
