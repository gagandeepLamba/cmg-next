...
export default function DepartmentsManagement() {
  ...
  const handleViewDepartment = (department: DmDepartmentAttributes) => {
    setSelectedDepartment(department);
    setShowModal(true);
  };

  const handleEditDepartment = (department: DmDepartmentAttributes) => {
    setSelectedDepartment(department);
  ...
  const handleAddDepartment = async (departmentData: Partial<DmDepartmentAttributes>) => {
    try {
  ...
  const handleUpdateDepartment = async (departmentData: Partial<DmDepartmentAttributes>) => {
...
interface DepartmentFormModalProps {
  title: string;
  initialData?: DmDepartmentAttributes | null;
  onSubmit: (data: Partial<DmDepartmentAttributes>) => void;
  onClose: () => void;
}
