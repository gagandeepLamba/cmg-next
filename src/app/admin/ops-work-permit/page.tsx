...
export default function OpsWorkPermitPage() {
  ...
  const fetchOperations = async () => {
    setLoading(true)
    try {
      const databaseOperations = (await searchOperationCases({ module: 'work-permit', search: searchTerm || null, limit: 100 }))
        .map(mapOperationsRowToListItem) as unknown as WorkPermitOps[]
      // Apply filters
