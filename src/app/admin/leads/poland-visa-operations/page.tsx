...
import PolandVisaOperationsWizard from '../poland-visa-operations-wizard';

function PolandVisaOperationsContent() {
...
export default function PolandVisaOperationsPage() {
  return (
