...
interface BusinessUkOperationsWizardProps {
...
const stageFieldMap: Record<string, StageField[]> = {
  ...
  registration: [
    { name: 'companyRegistration', label: 'Company Registration (Companies House)', type: 'select', options: statusOptions, required: true },
    { name: 'taxRegistration', label: 'Tax Registration (HMRC)', type: 'select', options: statusOptions },
    { name: 'vatRegistration', label: 'VAT Registration', type: 'select', options: statusOptions },
    ...
    { name: 'entrepreneurVisaStatus', label: 'Innovator/Entrepreneur Visa', type: 'select', options: statusOptions },
    { name: 'investorVisaStatus', label: 'Investor Visa', type: 'select', options: statusOptions },
...
const stageMeta: Record<string, StageMeta> = {
  ...
  business: { title: 'Business Details', description: 'Company profile, industry, and investment details for the UK business immigration case.', dataKey: 'business' },
  registration: { title: 'Registration & Visa Status', description: 'Companies House registration, HMRC/VAT, banking, and Innovator/Investor/Work/Family visa status tracking.', dataKey: 'registration' },
...
export default function BusinessUkOperationsWizard(props: BusinessUkOperationsWizardProps) {
  return (
    <OperationsWizardShell
      {...props}
      module="business-uk"
      pageTitle="UK Business Operations"
