...
import BusinessUsaOperationsWizard from '../business-usa-operations-wizard';

function BusinessUsaOperationsContent() {
...
export default function BusinessUsaOperationsPage() {
  return (
