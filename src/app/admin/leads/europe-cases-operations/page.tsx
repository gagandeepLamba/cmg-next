...
import EuropeCasesOperationsWizard from '../europe-cases-operations-wizard';

function EuropeCasesOperationsContent() {
...
export default function EuropeCasesOperationsPage() {
  return (
