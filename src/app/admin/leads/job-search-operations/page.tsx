...
import JobSearchOperationsWizard from '../job-search-operations-wizard';

function JobSearchOperationsContent() {
...
export default function JobSearchOperationsPage() {
  return (
