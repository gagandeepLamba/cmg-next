...
import WorkPermitOperationsWizard from '../work-permit-operations-wizard';

function WorkPermitOperationsContent() {
...
export default function WorkPermitOperationsPage() {
  return (
