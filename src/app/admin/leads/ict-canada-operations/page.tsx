...
import IctCanadaOperationsWizard from '../ict-canada-operations-wizard';

function IctCanadaOperationsContent() {
...
export default function IctCanadaOperationsPage() {
  return (
