...
import BusinessCanadaOperationsWizard from '../business-canada-operations-wizard';

function BusinessCanadaOperationsContent() {
  ...
  return (
    <BusinessCanadaOperationsWizard
...
export default function BusinessCanadaOperationsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gray-50 flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div></div>}>
      <BusinessCanadaOperationsContent />
    </Suspense>
  );
}
