...
export default function OpsSkillCanadaPIPPage() {
  ...
  const fetchOperations = async () => {
    setLoading(true)
    try {
      const databaseOperations = (await searchOperationCases({ module: 'skill-canada-pip', search: searchTerm || null, limit: 100 }))
        .map(mapOperationsRowToListItem) as unknown as SkillCanadaPIPOps[]
      // Apply filters
