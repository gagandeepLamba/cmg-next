...
export default function OpsFamilySponsorshipPage() {
  ...
  const fetchOperations = async () => {
    setLoading(true)
    try {
      const databaseOperations = (await searchOperationCases({ module: 'family-sponsorship', search: searchTerm || null, limit: 100 }))
        .map(mapOperationsRowToListItem) as unknown as FamilySponsorshipOps[]
      // Apply filters
