...
interface OldDataAuhAttributes {
  id: number;
  Agno: string | null;
...
interface OldDataAuhCreationAttributes extends Optional<OldDataAuhAttributes, 'Agno' | 'SignupDate' | 'ClientName' | 'Mobile' | 'Email' | 'Country' | 'Branch' | 'TotalPackage' | 'PaidAmount' | 'PendingAmount' | 'Counselor' | 'CPO1' | 'CPO2' | 'EcaStatus' | 'SpouseEca' | 'IETSstatus' | 'EEstatus' | 'Noc' | 'CRS' | 'StatusLastUpdated' | 'PnpSubmitted' | 'Decision' | 'Remarks' | 'flag'> {}

class OldDataAuh extends Model<OldDataAuhAttributes, OldDataAuhCreationAttributes> implements OldDataAuhAttributes {
  public id!: number;
...
OldDataAuh.init(
  ...
  {
    sequelize,
    modelName: 'OldDataAuh',
    tableName: 'old_data_auh',
    timestamps: false,
    freezeTableName: true,
  });

export { OldDataAuh };
export type { OldDataAuhAttributes, OldDataAuhCreationAttributes };
